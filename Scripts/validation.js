                         ...
                         case "LOGINID" :
						  ...
						  case "MYIMAGE":
							 ...
							 if(formnm.elements[i].value!=''){
								 ...
								 if(getFileName(formnm.elements[i].value).search(/^[0-9A-Za-z\s_(). -]+(.[jJ][pP][gG]|.[gG][iI][fF]|.[jJ][pP][eE][gG]|.[dD][oO][cC]|.[pP][nN][gG]|.[dD][oO][cC][xX]|.[pP][pP][tT]|.[pP][pP][tT][xX]|.[xX][lL][sS][xX]|.[zZ][iI][pP]|.[rR][tT][fF]|.[tT][xX][tT]|.[pP][dD][fF]|.[xX][lL][sS])$/)==-1){
									 alert(idInnerArray[1]);
									 formnm.elements[i].focus();
									 formnm.elements[i].select();
									 return false;
