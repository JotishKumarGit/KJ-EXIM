/****** Helpers.min.js Ver: 1.8.1 Copyright 2012, WeblinkIndia.Net *******/
...
/*Custom select*/
$(window).load(function(){if($("select.select_dg").length>0){$("option",this).renameAttr("value","data-value");var e=$("select.select_dg");e.each(function(e,t){var n=$("option",this);var r=$(t).wrapAll('<div class="select_label" />').find(":selected").addClass("selected").text();var i=$(t).find(":selected").attr("data-value");$(t).attr("name",$(this).attr("id")).attr("id","");var s=$(t,this).attr("name");$(t).parent().prepend("<p>"+r).width($(t).parent(".select_label").width()).append('<input type="hidden" id='+s+" name="+s+" value="+i+" />");n.each(function(e,t){$(t).changeElementType("li")})});e.changeElementType("ul");$(".select_label p").click(function(){$(this).next().slideToggle()});$(".select_dg li").click(function(){var e=$(this).text();var t=$(this).attr("data-value");$(this).parent().prev("p").html(e);$(this).parent().next("input").val(t);$("li",$(this).parent()).removeClass("selected");$(this).addClass("selected");$(this).parent("ul").slideToggle()});$(".select_label p").bind("mouseenter",function(){$(this).next().css({width:$(this).parents("div.select_label").width()})});$(".select_dg").parent().bind("mouseleave",function(){$(".select_dg",this).slideUp()})}else{}})